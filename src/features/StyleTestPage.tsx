				...
				<section className="section">
					...
					<div className="chess-board" style={{ margin: "2rem auto", maxWidth: "400px" }}>
						...
						{Array.from({ length: 32 }, (_, i) => {
							const isLightSquare = Math.floor(i / 8) % 2 === i % 2;
							const isRow5Col5 = i === 20; // Valid move highlight
							const isRow3Col4 = i === 27; // Selected square
							const isPawnMove = i === 28; // White pawn moved

							return (
								<div
									key={i}
									className={`chess-square ${isLightSquare ? "light-square" : "dark-square"} ${
										isRow5Col5 ? "valid-move" : ""
									} ${isRow3Col4 ? "selected" : ""}`}
								>
									{isPawnMove && <span className="chess-piece light-piece">♙</span>}
								</div>
							);
						})}
